...
#FFP8
'''chanmaskcls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/ffp8_pla_data/s2let_ilc_covar15_ffp8_diffuse_deconv_tapered_thresh_lmax3600_3600_hybridC_0_1_recon_cls.fits')[lmin:3392] * 1e12
n2cls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/ffp8_pla_data/s2let_ilc_covar15_ffp8_diffuse_deconv_tapered_thresh_lmax3600_1300_hybridC_0_2_recon_cls.fits')[lmin:lmax] * 1e12
n3cls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/ffp8_pla_data/s2let_ilc_covar15_ffp8_diffuse_deconv_tapered_thresh_lmax3600_1300_hybridC_0_3_recon_cls.fits')[lmin:lmax] * 1e12
n4cls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/ffp8_pla_data/s2let_ilc_covar15_ffp8_diffuse_deconv_tapered_thresh_lmax3600_1300_hybridC_0_4_recon_cls.fits')[lmin:lmax] * 1e12
n5cls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/ffp8_pla_data/s2let_ilc_covar15_ffp8_diffuse_deconv_tapered_thresh_lmax3600_1300_hybridC_0_5_recon_cls.fits')[lmin:lmax] * 1e12
inputcls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/ffp8_pla_data/ffp8_cmb_scl_000_full_cls_ilcbeam_lmax3399.fits')[lmin:3392] #Input'''
...
#n2cls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/diffuse_data/s2let_ilc_covar15_planck_diffuse_deconv_tapered_thresh_lmax3600_1300_hybridC_0_2_recon_cls.fits')[lmin:lmax] * 1e12
#n3cls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/diffuse_data/s2let_ilc_covar15_planck_diffuse_deconv_tapered_thresh_lmax3600_1300_hybridC_0_3_recon_cls.fits')[lmin:lmax] * 1e12
#n4cls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/diffuse_data/s2let_ilc_covar15_planck_diffuse_deconv_tapered_thresh_lmax3600_1300_hybridC_0_4_recon_cls.fits')[lmin:lmax] * 1e12
#n5cls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/diffuse_data/s2let_ilc_covar15_planck_diffuse_deconv_tapered_thresh_lmax3600_1300_hybridC_0_5_recon_cls.fits')[lmin:lmax] * 1e12
...
ax0.plot(ell_binned,chanmaskdls_binned,color=cols[0],label = r'Directional ILC $(N=1)$')
...
#Plot residuals
#FFP8
'''ax1.plot(ell_binned_long,chanmaskdls_binned - inputdls_binned,color=cols[0],label = r'Directional ILC $(N=1)$')
ax1.plot(ell_binned,n2dls_binned - inputdls_binned[:len(n2dls_binned)],color=cols[1],label = r'$N=2$')
ax1.plot(ell_binned,n3dls_binned - inputdls_binned[:len(n2dls_binned)],color=cols[2],label = r'$N=3$')
ax1.plot(ell_binned,n4dls_binned - inputdls_binned[:len(n2dls_binned)],color=cols[3],label = r'$N=4$')
ax1.plot(ell_binned,n5dls_binned - inputdls_binned[:len(n2dls_binned)],color=cols[4],label = r'$N=5$')'''

#PR2
ax1.plot(ell_binned,chanmaskdls_binned - theorydls_binned,color=cols[0],label = r'Directional ILC $(N=1)$')
'''ax1.plot(ell_binned,n2dls_binned - theorydls_binned[:len(n2dls_binned)],color=cols[1],label = r'$N=2$')
ax1.plot(ell_binned,n3dls_binned - theorydls_binned[:len(n2dls_binned)],color=cols[2],label = r'$N=3$')
ax1.plot(ell_binned,n4dls_binned - theorydls_binned[:len(n2dls_binned)],color=cols[3],label = r'$N=4$')
ax1.plot(ell_binned,n5dls_binned - theorydls_binned[:len(n2dls_binned)],color=cols[4],label = r'$N=5$')'''
...
#ax.set_yscale('log')
plt.savefig('/Users/keir/Documents/s2let_ilc_latex/s2let_ilc_papers/s2let_ilc_temp/nilcspec_n1_resids3.pdf')

#Panel 3
f2, ax2 = plt.subplots(1,figsize=(8,4))
botlim = 150
ax2.plot(ell_binned[:botlim],chanmaskdls_binned[:botlim] - theorydls_binned[:botlim],color=cols[0],label = r'Directional ILC $(N=1)$')
...
plt.savefig('/Users/keir/Documents/s2let_ilc_latex/s2let_ilc_papers/s2let_ilc_temp/nilcspec_n1_resids3_botpan.pdf')
