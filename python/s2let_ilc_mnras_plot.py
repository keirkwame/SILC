...
plt.rc('font', family='serif',size=17.0) #21 for power spectra #17 for maps
...
#n1map_masked = hp.read_map('/Users/kwame/Documents/s2let_ilc_data/s2let_ilc_covar15_planck_diffuse_deconv_tapered_thresh_lmax3600_3600_hybridC_6_1_recon_inpaint1600.fits') * 1e6 #uK
...
ffp8map_downgrade = hp.read_map('/Users/kwame/Documents/s2let_ilc_data/s2let_ilc_covar15_ffp8_diffuse_deconv_tapered_thresh_lmax3600_1300_hybridC_0_2_recon_lmin2_lmax256.fits')
inputmap_downgrade = hp.read_map('/Users/kwame/Documents/s2let_ilc_data/ffp8_cmb_scl_000_full_map_dg.fits')
'''inputmap_downgrade = hp.remove_dipole(inputmap_downgrade) #Checking that no mono-/dipole'''
ut78 = hp.ud_grade(hp.read_map('/Users/kwame/Documents/s2let_ilc_data/nilc_pr2_UTA76.fits'),nside_out=128)
...
LIM = 15
hp.mollview(diffmap,unit=r'$\mu\mathrm{K}$',title=r"SILC $(N = 2)$ - input [FFP8]",min=-1.*LIM,max=LIM)
plt.savefig('/Users/kwame/Documents/s2let_ilc_papers/s2let_ilc_temp/diffmap8_n2_input_biased.pdf')
...
'''lmin = 2
lmax = 3392
theorycls = hp.read_cl('/Users/kwame/Documents/s2let_ilc_data/planck2015_4_scalCls.fits')[0][lmin:lmax] * 1e12 #(uK)^2
...
#FFP8
'''chanmaskcls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/scal_data/s2let_ilc_covar15_ffp8_diffuse_deconv_tapered_thresh_lmax3600_3600_hybridC_6_1_recon_masked.fits')[lmin:lmax] #* 1e12
n2cls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/scal_data/s2let_ilc_covar15_ffp8_diffuse_deconv_tapered_thresh_lmax3600_3600_hybridC_6_2_recon_masked.fits')[lmin:lmax] #* 1e12
n3cls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/scal_data/s2let_ilc_covar15_ffp8_diffuse_deconv_tapered_thresh_lmax3600_3600_hybridC_6_3_recon_masked.fits')[lmin:lmax] #* 1e12
n4cls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/scal_data/s2let_ilc_covar15_ffp8_diffuse_deconv_tapered_thresh_lmax3600_3600_hybridC_6_4_recon_masked.fits')[lmin:lmax] #* 1e12
n5cls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/scal_data/s2let_ilc_covar15_ffp8_diffuse_deconv_tapered_thresh_lmax3600_3600_hybridC_6_5_recon_masked.fits')[lmin:lmax] #* 1e12
inputcls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/ffp8_pla_data/ffp8_cmb_scl_000_full_cls_masked.fits')[lmin:lmax]'''
...
#PR2
#chanmaskcls_corrected = hp.read_cl('/Users/kwame/Documents/s2let_ilc_data/s2let_ilc_covar15_planck_diffuse_deconv_tapered_thresh_lmax3600_3600_hybridC_6_1_recon_masked.fits')[lmin:lmax] #* 1e12
'''n2cls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/scal_data/s2let_ilc_covar15_planck_diffuse_deconv_tapered_thresh_lmax3600_3600_hybridC_6_2_recon_masked.fits')[lmin:lmax] #* 1e12
n3cls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/scal_data/s2let_ilc_covar15_planck_diffuse_deconv_tapered_thresh_lmax3600_3600_hybridC_6_3_recon_masked.fits')[lmin:lmax] #* 1e12
n4cls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/scal_data/s2let_ilc_covar15_planck_diffuse_deconv_tapered_thresh_lmax3600_3600_hybridC_6_4_recon_masked.fits')[lmin:lmax] #* 1e12
n5cls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/scal_data/s2let_ilc_covar15_planck_diffuse_deconv_tapered_thresh_lmax3600_3600_hybridC_6_5_recon_masked.fits')[lmin:lmax] #* 1e12'''
'''inputcls_corrected = hp.read_cl('/Users/kwame/Documents/s2let_ilc_data/nilc_pr2_cls_masked.fits')[lmin:lmax] #* 1e12
smicacls = hp.read_cl('/Users/kwame/Documents/s2let_ilc_data/smica_pr2_ilcbeam_lmax3399_cls_masked.fits')[lmin:lmax] #* 1e12'''
...
'''cols = dc.get_distinct(2)

f, (ax0,ax1) = plt.subplots(2,sharex=True,figsize=(8,8))
ax0.plot(ell_binned,chanmaskdls_binned,color='k',label = r'SILC $(N = 1)$')'''
...
'''ax0.plot(ell_binned,inputdls_binned,color=cols[0],label = r'NILC')
ax0.plot(ell_binned,smicadls_binned,color=cols[1],label = r'SMICA')'''
...
ax0.legend(prop={'size':21},frameon=False) #loc='lower right')'''
...
#PR2
#ax1.plot(ell_binned,chanmaskdls_binned - theorydls_binned,color='k',label = r'$N=1$')
...
'''ax1.plot(ell_binned,inputdls_binned - theorydls_binned,color=cols[0],label = r'NILC')
ax1.plot(ell_binned,smicadls_binned - theorydls_binned,color=cols[1],label = r'SMICA')'''
...
ax1.set_ylabel(r'$\Delta D_{\ell}$ $[{\mu\mathrm{K}}^2]$', labelpad = -4) #No labelpad for FFP8
...
#ax.set_yscale('log')
plt.savefig('/Users/kwame/Documents/s2let_ilc_papers/s2let_ilc_temp/smicaspec_n1_resids6.pdf')
...
#PR2
#ax2.plot(ell_binned[:botlim],chanmaskdls_binned[:botlim] - theorydls_binned[:botlim],color='k',label = r'$N=1$')
...
'''ax2.plot(ell_binned[:botlim],inputdls_binned[:botlim] - theorydls_binned[:botlim],color=cols[0],label = r'NILC')
ax2.plot(ell_binned[:botlim],smicadls_binned[:botlim] - theorydls_binned[:botlim],color=cols[1],label = r'SMICA')'''
...
ax2.set_ylabel(r'$\Delta D_{\ell}$ $[{\mu\mathrm{K}}^2]$', labelpad = -4) #No labelpad for FFP8
ax2.xaxis.tick_top()
...
plt.savefig('/Users/kwame/Documents/s2let_ilc_papers/s2let_ilc_temp/smicaspec_n1_resids6_botpan.pdf')'''
