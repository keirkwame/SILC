...
#n1map = hp.read_map('/Users/keir/Documents/s2let_ilc_planck/diffuse_data/s2let_ilc_covar15_planck_diffuse_deconv_tapered_thresh_lmax3600_3600_hybridC_0_5_recon.fits') * 1e6 #uK
...
n5cls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/ffp8_pla_data/s2let_ilc_covar15_ffp8_diffuse_deconv_tapered_thresh_lmax3600_3600_hybridC_0_5_recon_cls.fits')[lmin:lmax] * 1e12
...
#ax0.plot(ell_binned,inputdls_binned,ls='--',color='k',label = r'NILC')
...
#ax.set_yscale('log')
plt.savefig('/Users/keir/Documents/s2let_ilc_latex/s2let_ilc_papers/s2let_ilc_temp/smicaspec_n1_resids.pdf')
...
plt.savefig('/Users/keir/Documents/s2let_ilc_latex/s2let_ilc_papers/s2let_ilc_temp/smicacspec_n1_resids_botpan.pdf')'''
