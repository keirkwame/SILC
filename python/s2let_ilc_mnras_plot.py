...
plt.rc('font', family='serif',size=21.0)
...
ax0.legend(prop={'size':21},frameon=False) #loc='lower right') #Usually 18
...
#ax.set_yscale('log')
plt.savefig('/Users/keir/Documents/s2let_ilc_latex/s2let_ilc_papers/s2let_ilc_temp/ffp8spec_n5_resids7.pdf')
...
plt.savefig('/Users/keir/Documents/s2let_ilc_latex/s2let_ilc_papers/s2let_ilc_temp/ffp8spec_n5_resids7_botpan.pdf')
