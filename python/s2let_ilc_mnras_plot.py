...
plt.rc('font', family='serif',size=17.0) #21 for power spectra
...
#n1map = hp.read_map('/Users/keir/Documents/s2let_ilc_planck/diffuse_data/s2let_ilc_covar15_planck_diffuse_deconv_tapered_thresh_lmax3600_3600_hybridC_0_1_recon.fits') * 1e6 #uK
...
plt.savefig('/Users/keir/Documents/s2let_ilc_latex/s2let_ilc_papers/s2let_ilc_temp/n5map.pdf')'''
...
ffp8map_downgrade = hp.read_map('/Users/keir/Documents/s2let_ilc_planck/ffp8_pla_data/s2let_ilc_covar15_ffp8_diffuse_deconv_tapered_thresh_lmax3600_1300_hybridC_0_5_recon_lmin10_lmax256.fits')
inputmap_downgrade = hp.read_map('/Users/keir/Documents/s2let_ilc_planck/ffp8_pla_data/ffp8_cmb_scl_000_full_map_ilcbeam_lmin10_lmax256.fits')
'''inputmap_downgrade = hp.remove_dipole(inputmap_downgrade) #Checking that no mono-/dipole'''
ut78 = hp.ud_grade(hp.read_map('/Users/keir/Documents/s2let_ilc_planck/nilc_pr2_UTA76.fits'),nside_out=128)
...
LIM = 15
hp.mollview(diffmap,unit=r'$\mu\mathrm{K}$',title=r'SILC $(N=5)$ - input [FFP8]',min=-1.*LIM,max=LIM)
plt.savefig('/Users/keir/Documents/s2let_ilc_latex/s2let_ilc_papers/s2let_ilc_temp/diffmap_n5_input_lmin10.pdf')
...
hp.write_cl('/Users/keir/Documents/s2let_ilc_planck/diffuse_data/s2let_ilc_covar15_planck_diffuse_deconv_tapered_thresh_lmax3600_3600_hybridC_0_1_recon_cls_masked.fits',chanmaskcls_corrected)'''
...
#PR2
'''chanmaskcls_corrected = hp.read_cl('/Users/keir/Documents/s2let_ilc_planck/diffuse_data/s2let_ilc_covar15_planck_diffuse_deconv_tapered_thresh_lmax3600_3600_hybridC_0_1_recon_cls_masked.fits')[lmin:lmax] #* 1e12
...
ax0.legend(prop={'size':20},frameon=False) #loc='lower right') #Usually 18'''
...
#ax.set_yscale('log')
plt.savefig('/Users/keir/Documents/s2let_ilc_latex/s2let_ilc_papers/s2let_ilc_temp/smicaspec_n5_resids.pdf')
...
plt.savefig('/Users/keir/Documents/s2let_ilc_latex/s2let_ilc_papers/s2let_ilc_temp/smicaspec_n5_resids_botpan.pdf')'''
