...
#ax0.plot(ell_binned,smicadls_binned,color=cols[5],label = r'SMICA')
...
#ax1.plot(ell_binned,smicadls_binned - theorydls_binned,color=cols[5],label = r'SMICA')
...
#ax2.plot(ell_binned[:botlim],smicadls_binned[:botlim] - theorydls_binned[:botlim],color=cols[5],label = r'SMICA')
