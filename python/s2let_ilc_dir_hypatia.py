...
if __name__ == "__main__":
    ...
    fitsdir = '/home/keir/s2let_ilc_data/ffp6_pla_data/' #'/Users/keir/Documents/s2let_ilc_planck/weights/' #'/Users/keir/Documents/s2let_ilc_planck/deconv_data/'
    fitsroot = 'ffp6_pla_deconv_' #'planck_deconv_tapered_thresh_' #'ffp6_fiducial_withPS_tapered_' #'planck_deconv_tapered_minusgaussps_' #'planck_deconv_tapered_pr1_' #'ffp6_fiducial_noPS_tapered_' #'ffp6_combined_mc_0000_deconv_' #'simu_dirty_beam_wmap_9yr_' #'wmap_deconv_nosource_smoothw_extrapolated_9yr_'
