...
if __name__ == "__main__":
    ...
    fitsdir = '/Users/keir/Documents/s2let_ilc_planck/diffuse_data/' #'/home/keir/s2let_ilc_data/maps/' #'/Users/keir/Documents/s2let_ilc_planck/maps/PR2/frequencyMaps/'
    fitsprefix = ['LFI','LFI','LFI','HFI','HFI','HFI','HFI','HFI','HFI'] #['030/LFI','044/LFI','070/LFI','100/HFI','143/HFI','217/HFI','353/HFI','545/HFI','857/HFI']
    fitsroot = 'planck_diffuse_' #'_SkyMap_'
    ...
    outdir = '/Users/keir/Documents/s2let_ilc_planck/diffuse_data/' #'/home/keir/s2let_ilc_data/hybrid_data/'
    outroot = 'planck_diffuse_deconv_tapered_thresh_lmax1300_'
    outcode = beamcode
    outend = '_pr2.fits'
    outfits = [None]*nmaps
